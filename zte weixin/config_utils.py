...
def fill_default_config(config):
    set_config_default_value(config, 'qywx_host', 'qyapi.weixin.qq.com')
    set_config_default_value(config, 'corp_id', '')
    set_config_default_value(config, 'corp_secret', '')
    set_config_default_value(config, 'agent_id', '')
    set_config_default_value(config, 'qywx_user', '')
